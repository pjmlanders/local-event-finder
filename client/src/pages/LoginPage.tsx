    ...
    <div className="flex min-h-[70vh] items-center justify-center px-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-500">Save favorites and sync your preferences</p>
        </div>
        ...
        <div className="surface-card p-6 space-y-4">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-50 disabled:opacity-50"
          >
